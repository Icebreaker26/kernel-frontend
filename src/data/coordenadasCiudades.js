// Coordenadas [longitud, latitud] de las ciudades y municipios donde hay asociados. Las comparten el mapa de
// estadísticas de sorteos y la diapositiva de presencia de la presentación pública de captación.
// Las claves van en MAYÚSCULAS, con y sin tilde, como vienen en asociados.ciudad.
export const COORDS_CIUDADES = {
...
export const coordenadasDe = (ciudad) => {
  if (!ciudad) return null;
  const key = ciudad.toUpperCase().trim();
  return COORDS_CIUDADES[key] ?? null;
};
