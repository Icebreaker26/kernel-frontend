    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-[#08101e] border rounded-sm w-full max-w-2xl max-h-[92vh] overflow-hidden flex flex-col relative"
        ...
        <div className="flex-1 overflow-y-auto px-7 py-5 space-y-5">
          ...
          {/* Banner devolución Gerencia */}
          {f.estado === 'aprobada' && f.rechazo_motivo && (
            <div className="p-4 rounded-sm border border-[#f59e0b44] bg-[#f59e0b08]">
              <p className="text-[10px] tracking-[3px] text-[#f59e0b] mb-2">⚠ DEVUELTA POR GERENCIA</p>
              <p className="text-base text-[#fbbf24]">{f.rechazo_motivo}</p>
              <p className="text-[10px] text-[#475569] mt-2">
                Esta factura fue revisada por Gerencia y devuelta para re-verificación. Al verificarla nuevamente volverá a Gerencia para su aprobación.
              </p>
            </div>
          )}
            ...
            return (
              <div key={f.id}
                ...
                <div className="flex items-center gap-3 flex-wrap mb-3">
                  ...
                  {f.estado === 'aprobada' && f.rechazo_motivo && (
                    <span className="flex items-center gap-1 text-[10px] tracking-wide px-2 py-0.5 rounded-sm border border-[#f59e0b44] text-[#f59e0b] bg-[#f59e0b11]">
