    ...
    <button
      ...
      className={`flex items-center gap-2.5 w-full px-3 py-2 rounded-sm text-[10px] tracking-widest transition-all border ${
        active
          ...
          : 'border-transparent text-[#6aacbc] hover:text-[#a0d4e0] hover:border-[#818cf811] hover:bg-[#818cf808]'
      }`}
    >
      ...
      <aside className="w-52 border-r border-[#818cf822] flex flex-col py-6 px-4 shrink-0 bg-[#08101e] relative">
        ...
        <div className="mb-6 pb-4 border-b border-[#818cf811]">
          <button
            ...
            className="flex items-center gap-1.5 w-full px-2 py-1.5 mb-3 rounded-sm border border-[#818cf822] bg-[#818cf808] hover:bg-[#818cf815] hover:border-[#818cf855] text-[#6aacbc] hover:text-[#818cf8] text-[10px] tracking-wider transition-all"
          >
          ...
          <p className="text-[#6aacbc] text-[9px] mt-0.5 tracking-[3px]">// CONTABLE</p>
        </div>
