      ...
      <div className="relative z-[2] mx-auto max-w-[1200px] px-4 py-6">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <MessageSquareWarning size={18} style={{ color: ACCENT }} />
            <div>
              <p className="text-[8px] tracking-[4px] text-[#6aacbc]">// COOPERATIVA PROGRESEMOS</p>
              <h1 className="text-xl font-bold tracking-[4px]" style={{ color: ACCENT, textShadow: `0 0 20px ${ACCENT}55` }}>PQRS</h1>
            </div>
          </div>
        </div>
        <Outlet />
