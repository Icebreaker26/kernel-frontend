...
import { LogOut, Upload, UsersRound, ClipboardList, Building2, ChevronLeft, Menu, X, BarChart2, Activity, ShieldAlert } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/admin/seguridad',          end: false, icon: ShieldAlert,   label: 'Seguridad' },
];
