...
import { ChevronLeft, LayoutDashboard, CreditCard, ArrowLeftRight, Building2, FileText, LogOut, Upload, Banknote } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#05080f] font-mono flex">
      ...
      <aside className="w-52 border-r border-[#34d39922] flex flex-col py-6 px-4 shrink-0 bg-[#08101e] relative">
        ...
        <nav className="flex flex-col gap-1 flex-1">
          ...
          <NavItem icon={Banknote}        label="DESEMBOLSOS"  path="/tesoreria/desembolsos"  current={pathname} />
        ...
        <div className="border-t border-[#34d39911] pt-4 mt-2">
          <div className="flex items-center gap-2 mb-2">
            <UserAvatar url={user?.avatar_url} nombre={user?.nombre} size={28} accent="#34d399" />
