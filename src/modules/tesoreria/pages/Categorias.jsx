            ...
            <div key={tipo}>
              ...
              <div className="space-y-1">
                {agrupadas[tipo].map(c => (
                  <div key={c.id} className="flex items-center justify-between px-3 py-2 rounded-sm border border-[#34d39910] bg-[#34d39905] group hover:border-[#34d39922] transition-colors">
